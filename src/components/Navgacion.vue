<template>
  <v-navigation-drawer app bottom permanent clipped expand-on-hover>
    <v-list>
      <v-list-item class="px-2">
        <v-list-item-avatar>
          <!-- <v-icon>mdi-domain</v-icon>
           -->
          <div class="my-2">
            <v-btn color="deep-purple accent-2" fab x-large dark>
              <v-icon>mdi-domain</v-icon>
            </v-btn>
          </div>
